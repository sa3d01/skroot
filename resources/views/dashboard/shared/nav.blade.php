      <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="{{asset('/assets/brand/coreui-base-white.svg')}}" width="118" height="46" alt="CoreUI Logo">
          <img class="c-sidebar-brand-minimized" src="{{asset('/assets/brand/coreui-signet-white.svg')}}" width="118" height="46" alt="CoreUI Logo"></div>
      <nav class="c-sidebar-nav">
        <ul class="c-nav">
          <li class="c-nav-item"><a class="c-nav-link" href="/">
              ...
              <li class="c-nav-item"><a class="c-nav-link" href="{{route('login')}}" target="_top">
                  <svg class="c-nav-icon">
                    <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-account-logout"></use>
                  </svg> Login</a></li>
              <li class="c-nav-item"><a class="c-nav-link" href="{{route('register')}}" target="_top">
                  <svg class="c-nav-icon">
                    <use xlink:href="/assets/icons/coreui/free-symbol-defs.svg#cui-account-logout"></use>
                  </svg> Register</a></li>
